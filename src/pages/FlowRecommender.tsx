  ...
  useEffect(() => {
    const getDataAndRecommend = async () => {
      try {
        ...
        // Recommend flow based on closing_method and has_lead_magnet
        ...
        if (onboarding.closing_method === 'phone-call') {
          ...
          recommendedTemplate = 'no-booking'
        }
    ...
    >
      <style>{`
        ...
        @keyframes magnetGlow {
          0%, 100% {
            box-shadow: 0 0 30px rgba(196, 181, 253, 0.4), inset 0 1px 0 rgba(255,255,255,.8);
          }
          50% {
            box-shadow: 0 0 50px rgba(196, 181, 253, 0.6), inset 0 1px 0 rgba(255,255,255,.8);
          }
        }
        ...
        .fr-pulse-ring {
          animation: magnetPulseRing 2s ease-out infinite;
        }
        
        .fr-text {
          animation: typeText 0.8s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
      `}</style>
      ...
      >
        {/* Magnet Glass Circle Container */}
        <div style={{ position: 'relative', width: 240, height: 240 }}>
          {/* Pulse rings */}
          <div
            className="fr-pulse-ring"
            style={{
              position: 'absolute',
              inset: 0,
              borderRadius: '50%',
          ...
          >
            ...
            <div
              style={{
                ...
                height: 80,
                borderRadius: '50%',
                background: 'conic-gradient(from 0deg, #c4b5fd, #a78bfa, transparent)',
                opacity: 0.4,
